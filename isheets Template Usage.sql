...
parents as (		
    ...
    CUSTOM_TR_MARKET_SEGMENT_L_1,CUSTOM_TR_MARKET_SEGMENT_L_2, CUSTOM_COUNTRY, CUSTOM_DATACENTER
...
, FEATURE_GROUPING AS(
    ...
    -- AND FEATURE_NAME LIKE ANY 
    -- ('iSheets - Add','iSheets - Add - iSheet', 'iSheets - Add - Template',
    -- 'iSheets - Add - From an Excel file','iSheets - Add Template - Import Button',
    -- 'iSheets - Add - iSheet - Save (All)','isheets - Import from an Excel - Review/Import'
    --                               )
)
...
count(distinct b.ACCOUNTID) as sites,
--B.AGENT_SITEPURPOSE , 
-- B.CUSTOM_CUSTOMERNAME
-- ,B.CUSTOM_TR_MARKET_SEGMENT_L_1,B.CUSTOM_TR_MARKET_SEGMENT_L_2, B.CUSTOM_COUNTRY , B.CUSTOM_DATACENTER,
-- VISITOR_ID,
-- --,PRODUCT_AREA, 
-- FEATURE_NAME, 
